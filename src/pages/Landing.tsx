...
export default function Landing() {
    ...
    return (
        ...
        >
            <div
                className='w-full max-w-[1440px] min-h-screen flex flex-col justify-center items-center overflow-x-hidden'
            >
                ...
                <div className='w-full h-full flex flex-col justify-center items-center z-0'>
                    <div className='w-full h-[120vh] lg:h-screen flex flex-col lg:flex-row justify-center lg:gap-0 lg:justify-between items-center px-2 lg:px-8'>
